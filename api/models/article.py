...
class Article(BaseModel):
    title = models.CharField(help_text="title model help_text", max_length=255, blank=False, null=False,
                             validators=[alphanumeric, MinLengthValidator(10)])
    body = models.TextField(help_text="article model help_text", max_length=2048, blank=False, null=False,
